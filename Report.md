...
Follow the instructions in either `Navigation_local.ipynb` for local computer or `Navigation_WS.ipynb` for udacity workspace to get started with training your own agent! Note only local is fully updated.
